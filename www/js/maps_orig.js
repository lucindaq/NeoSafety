...
(function () {
    ...
    initializeRating = {
        ...
        init: function () {
            ...
            app.locationService.getCurrentPosition(function crimeResult (position) {
...
//                var longitude = -122.4021821;
                ...
                geocoder.geocode({'location': latlng}, function(results, status) {
                    if (results[1]) {
                        var index = parseInt(results[1].address_components.length/2);
                        county = results[1].address_components[index].long_name;
                                ...
                                success:     function (json) {
                                    ...
                                    if (json) {
                                        ...
                                        if (county == alamedaCounty) {
                                            ...
                                            rating = murderCount / 5 + theftCount / 30 + subAbuseCount / 60 + assaultCount / 40 + sexualCount / 20 + otherCount / 20;
                                            if (rating > 6) {
                                                rating = 6;
                                            }
                                        }
